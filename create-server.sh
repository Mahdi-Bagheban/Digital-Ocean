...
C_DEF="\033[39m"  # پیش‌فرض

C_GRN="\033[32m"  # سبز - ناجحیت و موفقیت
C_RED="\033[31m"  # قرمز - خطا
C_YEL="\033[33m"  # زرد - هشدار
C_BLU="\033[34m"  # آبی - اطلاعات
C_CYN="\033[36m"  # سبز آبی - مرحله
C_MAG="\033[35m"  # بنفش - تاکید
